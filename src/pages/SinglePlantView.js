            ...
            <div className="single-plant-view-main-container">
              ...
              <div>
                ...
                <ul>
                  <li>
                    Life cycle:{" "}
                    {singlePlant[0].life.includes("a")
                      ? "annual"
                      : singlePlant[0].life.includes("b")
                      ? "biannual"
                      : "perennial"}
                  </li>
                  ...
                  <li>
                    When to sow seeds:{" "}
                    {singlePlant[0].weeksBeforeLastFrost < -4
                      ? "Late Winter"
                      : singlePlant[0].weeksBeforeLastFrost >= -4 &&
                        singlePlant[0].weeksBeforeLastFrost <= -1
                      ? "Spring before last frost"
                      : singlePlant[0].weeksBeforeLastFrost >= 0 &&
                        singlePlant[0].weeksBeforeLastFrost <= 2
                      ? "Spring just after last frost"
                      : singlePlant[0].weeksBeforeLastFrost >= 3 &&
                        singlePlant[0].weeksBeforeLastFrost <= 8
                      ? "Mid to Late Spring"
                      : singlePlant[0].weeksBeforeLastFrost >= 9 &&
                        singlePlant[0].weeksBeforeLastFrost <= 12
                      ? "Early Summer"
                      : singlePlant[0].weeksBeforeLastFrost >= 13 &&
                        singlePlant[0].weeksBeforeLastFrost <= 18
                      ? "Summer"
                      : singlePlant[0].weeksBeforeLastFrost >= 19 &&
                        singlePlant[0].weeksBeforeLastFrost <= 24
                      ? "Late Summer"
                      : "Fall"}
                  </li>
                </ul>
                <div className="SinglePlant-ViewAllLink">
                  <Link to="/allplants">Back to View All</Link>
                </div>
              </div>
            </div>
          ) : null}
