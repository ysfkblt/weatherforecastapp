                ...
                <div className="filtering filterPlantType">
                  ...
                  <div className="filterColumn ">
                    <span className="filterType">
                      {plantTypes.map((type) => (
                        <Checkbox type={type} handleChange={checkedBoxType} />
                      ))}
                    </span>
                  </div>
                </div>
                ...
                <div className="filtering filterPlantLife">
                  ...
                  <div className="filterColumn ">
                    <span className="filterLife">
                      {plantLife.map((life) => (
                        <Checkbox type={life} handleChange={checkedBoxLife} />
                      ))}
                    </span>
                  </div>
                </div>
                ...
                <div className="filtering filterPlantLight">
                  ...
                  <div className="filterColumn ">
                    <span className="filterLight">
                      {transplantTo.map((light) => (
                        <Checkbox type={light} handleChange={checkedBoxLight} />
                      ))}
                    </span>
                  </div>
                </div>
                ...
                return (
                  <div className="singlePlant" key={plant.id}>
                    ...
                    <div className="singlePlantTransportTo">
                      Light:{" "}
                      {plant.transplantTo === "psha"
                        ? "partial shade"
                        : plant.transplantTo === "fsha"
                        ? "full shade"
                        : plant.transplantTo === "fsun"
                        ? "full sun"
                        : "partial sun"}
                    </div>
                  </div>
